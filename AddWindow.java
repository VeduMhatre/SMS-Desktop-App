...
class AddWindow extends JFrame{
	...
	AddWindow(){
		...
		JLabel labHead = new JLabel("Add Student Details");
		...
		labHead.setFont(new Font("Georgia", Font.BOLD, 25));
		labRno.setFont(f);
		txtRno.setFont(f);
		labName.setFont(f);	
		txtName.setFont(f);
		...
		labHead.setBounds(250, 5, 300, 40);
		...
		labSb3.setBounds(150, 250, 280, 40);  // x=150, y=260, width=280, height=40
		txtSb3.setBounds(450, 250, 200, 40);  // x=450, y=260, width=200, height=40

		btnSave.setBounds(180, 315, 200, 50); // x=200, y=330, width=200, height=50
		btnBack.setBounds(440, 315, 200, 50); // x=460, y=330, width=200, height=50
